 ...
 */
class KundeStatus extends Page
{
    ...
    protected function getViewData()
    {
        ...
        if(isset($_SESSION["bestID"])) {
            ...
            $SQLquery = "SELECT name,address, ordered_article_id,status FROM ordering natural join ordered_article natural join article
            WHERE ordering_id = $bestID"; //ordered_article.article_id = article.article_id AND ordered_article.
    ...
    protected function generateView()
    {
        ...
        if(!empty($Orders)){
            ...
            $this->serializedData = json_encode($Orders);
